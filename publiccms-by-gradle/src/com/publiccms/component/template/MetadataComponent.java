package com.publiccms.component.template;
...
public class MetadataComponent extends Base implements Cache {
    ...
    private static CacheEntity<String, Map<String, CmsPageMetadata>> pageCache = new MemoryCacheEntity<String, Map<String, CmsPageMetadata>>();
    private static CacheEntity<String, Map<String, CmsPlaceMetadata>> placeCache = new MemoryCacheEntity<String, Map<String, CmsPlaceMetadata>>();
