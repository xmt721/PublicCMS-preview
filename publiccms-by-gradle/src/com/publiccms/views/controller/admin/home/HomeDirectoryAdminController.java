...
import com.publiccms.service.home.HomeDirectoryService;
...
public class HomeDirectoryAdminController extends AbstractController {
        ...
        if (notEmpty(entity)) {
            ...
            logOperateService
                    .save(new LogOperate(site.getId(), getAdminFromSession(session).getId(), LogLoginService.CHANNEL_WEB_MANAGER,
                            "enable.home.directory", getIpAddress(request), getDate(), id + ":" + entity.getTitle()));
        }
    ...
    public String disable(Long id, HttpServletRequest request, HttpSession session, ModelMap model) {
        ...
        if (notEmpty(entity)) {
            ...
            logOperateService
                    .save(new LogOperate(site.getId(), getAdminFromSession(session).getId(), LogLoginService.CHANNEL_WEB_MANAGER,
                            "disable.home.directory", getIpAddress(request), getDate(), id + ":" + entity.getTitle()));
        }
        return TEMPLATE_DONE;
    }
