...
public class CmsCategoryListDirective extends AbstractTemplateDirective {
    ...
    public void execute(RenderHandler handler) throws IOException, Exception {
        ...
        PageHandler page = service.getPage(getSite(handler).getId(), handler.getInteger("parentId"), handler.getInteger("typeId"),
                handler.getBoolean("allowContribute"), disabled, handler.getInteger("pageIndex", 1),
