 ...
 */
@Entity
@Table(name = "sys_email_token", uniqueConstraints = @UniqueConstraint(columnNames = "auth_token"))
public class SysEmailToken implements java.io.Serializable {
    ...
    public SysEmailToken(int userId, String email, String authToken, Date createDate) {
        this.userId = userId;
        this.email = email;
