...
public class HomeBroadcast implements java.io.Serializable {
    ...
    private int scores;
    @MyColumn(title = "转发数", order = true)
    private int reposts;
    @MyColumn(title = "评论", order = true)
    private int comments;
    @MyColumn(title = "内容", order = true)
    private String message;
    @MyColumn(title = "转发", condition = true)
    private boolean reposted;
    @MyColumn(title = "转发ID", condition = true)
